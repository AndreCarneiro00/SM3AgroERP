package com.sm3Agro.SM3AgroERP.masterData.product.service;
...
public class ProductService {
    ...
    public Product create(CreateProductRequest request) {
        ...
        builder.hasStock(resolveCreateHasStock(request.hasStock()));
        builder.stockControlStartDate(resolveStockControlStartDate(
                request.hasStock(),
